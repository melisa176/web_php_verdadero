...
<html lang="en">
  ...
  <head>
    ...
    <meta
      name="keywords"
      content="bootstrap 5, bootstrap, bootstrap 5 admin dashboard, bootstrap 5 dashboard, bootstrap 5 charts, bootstrap 5 calendar, bootstrap 5 datepicker, bootstrap …
[9:22 a.m., 5/2/2025] Sebas: index2.html
[9:47 a.m., 5/2/2025] Sebas: <?php session_start(); ?>
...
<!--end::User Menu Dropdown-->
    ...
    function searchUser() {
        ...
        for (i = 1; i < tr.length; i++) { // Start from 1 to avoid the header row
            td = tr[i].getElementsByTagName("td")[1]; // Check the second column (username)
            if (td) {
